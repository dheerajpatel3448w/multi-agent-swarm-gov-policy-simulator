...
.status-indicator.ready .dot { background: #00ff88; box-shadow: 0 0 8px #00ff88; }
.status-indicator.processing .dot { background: var(--accent-orange); animation: pulse 1s infinite; box-shadow: 0 0 8px var(--accent-orange); }
.status-indicator.completed .dot { background: #00ff88; box-shadow: 0 0 8px #00ff88; }
.status-indicator.error .dot { background: var(--accent-red); box-shadow: 0 0 8px var(--accent-red); }

@keyframes pulse { 50% { opacity: 0.5; box-shadow: 0 0 2px var(--accent-orange); } }
