...
const loadHistory = async () => {
  try {
    ...
    console.error('History Projects:', error)
    projects.value = []
  } finally {
    loading.value = false
  }
...
.status-icon:nth-child(2).available { color: #F59E0B; } /* Environment Setup -  */
...
/* ProgressStatus */
.card-progress.completed { color: #10B981; }    /* Complete -  */
