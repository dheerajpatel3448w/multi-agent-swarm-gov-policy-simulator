...
REACT_FORCE_FINAL_MSG = "， Final Answer: Generate。"
...
class ReportManager:
    ...
    def get_report(cls, report_id: str) -> Optional[Report]:
        ...
        # Ifmarkdown_content，full_report.md
