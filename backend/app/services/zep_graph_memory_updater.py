...
class ZepGraphMemoryUpdater:
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        logger.info(f"ZepGraphMemoryUpdater : graph_id={graph_id}, batch_size={self.BATCH_SIZE}")
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        ...
        for attempt in range(self.MAX_RETRIES):
            try:
                ...
                logger.info(f"Success {len(activities)} {display_name} {self.graph_id}")
            ...
            if cls._updaters:
                for simulation_id, updater in list(cls._updaters.items()):
                    try:
                        ...
                        logger.error(f"Failed: simulation_id={simulation_id}, error={e}")
                cls._updaters.clear()
            logger.info("")
