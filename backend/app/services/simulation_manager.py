...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation config (time, activity, post frequency, etc.)
        ...
        try:
            ...
            profiles = generator.generate_profiles_from_entities(
                ...
                parallel_count=parallel_profile_count,  # Generate
                realtime_output_path=realtime_output_path,  # Save
            ...
            # Reddit is already saved in real-time during generation, save again here for completeness
            if progress_callback:
                progress_callback(
            ...
            # ========== Phase 3: LLM-based simulation config generation ==========
            if progress_callback:
                progress_callback(
                    "generating_config", 0,
