...
logger = get_logger('AGENTIXGOV.zep_tools')
    ...
    def interview_agents(
        ...
        try:
            ...
            if not api_result.get("success", False):
                ...
                result.summary = f"APIFailed：{error_msg}。OASIS。"
                return result
            ...
            result.summary = f"Failed：{str(e)}。，OASIS。"
            return result
        except Exception as e:
