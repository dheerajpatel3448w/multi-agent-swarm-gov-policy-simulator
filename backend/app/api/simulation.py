...
def create_simulation():
    ...
    try:
        ...
        logger.error(f"Create Simulation: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def prepare_simulation():
    """
    Prepare Simulation Environment（，LLM）
...
def get_prepare_status():
    ...
    try:
        ...
        if not task:
            # Task does not exist，simulation_id，
            if simulation_id:
                is_prepared, prepare_info = _check_simulation_prepared(simulation_id)
                if is_prepared:
                    return jsonify({
...
def get_simulation(simulation_id: str):
    ...
    try:
        ...
        logger.error(f"Get Simulation Status: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_simulation_history():
    ...
    try:
        ...
        for sim in simulations:
            ...
            # Get Simulation Config（ simulation_config.json  simulation_requirement）
...
def generate_profiles():
    """
    OASIS Agent Profile（Create Simulation）
...
def start_simulation():
    ...
    try:
                    ...
                    if run_state and run_state.runner_status.value == "running":
                        ...
                        if force:
                            ...
                            try:
                                ...
                                logger.warning(f"Stop Simulation: {str(e)}")
                        else:
                            return jsonify({
                                "success": False,
        ...
        logger.error(f"Start Simulation: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def stop_simulation():
    ...
    try:
        ...
        logger.error(f"Stop Simulation: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_simulation_actions(simulation_id: str):
    ...
    try:
        ...
        logger.error(f"Get Action History: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_env_status():
    ...
    try:
        ...
        logger.error(f"Get Environment Status: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
