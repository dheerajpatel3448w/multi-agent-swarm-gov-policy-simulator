...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        print(f"LLM: model={llm_model}, base_url={llm_base_url[:40] if llm_base_url else ''}...")
...
async def main():
    parser = argparse.ArgumentParser(description='OASIS Twitter')
    parser.add_argument(
        '--config', 
        type=str, 
        required=True,
